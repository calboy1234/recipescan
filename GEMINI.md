...
Project Overview
RecipeScan is an automated OCR pipeline designed for high-throughput processing of hundreds of thousands of images. It extracts, scores, and stores recipe text, optimizing for layout preservation and "recipe-ness" detection. A Flask-based web interface is provided for monitoring, managing, and interacting with the pipeline and its results.
...
*   **Web Interface (Flask App):**
    ...
    *   Provides endpoints for:
        *   Gallery view of scanned images.
        *   Detailed view of individual images and their OCR results.
